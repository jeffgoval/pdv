(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_2b7cc3._.js", {
...
const NewSaleScreen = ({ cart, onAdd, onRemove, onFinalize, onBack })=>{
    ...
    const fetchProducts = async ()=>{
        setLoading(true);
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('products').select('id, name, price, stock').eq('is_active', true).gt('stock', 0) // Only show products with stock
        .order('name');
        if (data) {
            setProducts(data);
        }
...
const PDVRaizApp = ()=>{
    ...
    const handleLogin = async ()=>{
        ...
        const { data: stores } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('stores').select('id').limit(1);
        if (!stores || stores.length === 0) {
            const { data: user } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('users').insert({
                name: 'Demo User',
                email: 'demo@pdvraiz.com',
                role: 'OWNER'
            }).select().single();
            if (user) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('stores').insert({
                    user_id: user.id,
                    name: 'Minha Loja',
                    address: {},
                    business_hours: {}
    ...
    const handleCreateSale = async (selectedMethod)=>{
        ...
        const { data: sale, error: saleError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('sales').insert({
            store_id: storeId,
            total: total,
            status: 'PENDING'
        }).select().single();
        ...
        const { error: itemsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('sale_items').insert(saleItems);
        if (itemsError) {
        ...
        if (selectedMethod === "cash") {
            const { data: payment } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('payments').insert({
                sale_id: sale.id,
                amount: total,
                method: 'CASH',
                status: 'PAID'
            ...
            if (payment) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].rpc('process_payment', {
                    payment_uuid: payment.id
                });
            }
            setView("payment-confirmation");
        } else {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('payments').insert({
                sale_id: sale.id,
                amount: total,
    ...
    return /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"]("div", {
        ...
        children: [
            /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"](AnimatePresence, {
                mode: "wait",
                children: [
                    view === "login" && /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"](motion.div, {
                        initial: {
                            opacity: 0,
                            x: 24
                        },
                    ...
                    view === "dashboard" && /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"](motion.div, {
                        initial: {
                            opacity: 0,
                            x: 24
                        },
                    ...
                    view === "products" && /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"](motion.div, {
                        initial: {
                            opacity: 0,
                            x: 24
                        },
                    ...
                    view === "new-sale" && /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"](motion.div, {
                        initial: {
                            opacity: 0,
                            x: 24
                        },
                    ...
                    view === "payment-method" && /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"](motion.div, {
                        initial: {
                            opacity: 0,
                            x: 24
                        },
                    ...
                    view === "payment-waiting" && method && /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"](motion.div, {
                        initial: {
                            opacity: 0,
                            x: 24
                        },
                    ...
                    view === "payment-confirmation" && /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"](motion.div, {
                        initial: {
                            opacity: 0,
                            x: 24
                        },
                    ...
                    view === "sales-history" && /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"](motion.div, {
                        initial: {
                            opacity: 0,
                            x: 24
                        },
                    ...
                    view === "profile" && /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"](motion.div, {
                        initial: {
                            opacity: 0,
                            x: 24
                        },
            ...
            (view === 'dashboard' || view === 'products' || view === 'profile') && /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"]("div", {
