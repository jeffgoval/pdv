      ...
      <div className="flex flex-col gap-4">
        ...
        >
          <span className="flex items-center gap-3">
            ...
            <span className="text-sm font-bold text-gray-800">Novo produto</span>
          </span>
          <span className="text-xs text-gray-500 font-medium">nome, preço, estoque</span>
        </button>
        ...
        <div className="flex flex-col gap-3">
          {loading ? (
             ...
             <div className="p-8 text-center bg-white rounded-2xl border-2 border-gray-200">
               ...
               <p className="text-sm text-gray-600 font-medium">Nenhum produto encontrado.</p>
               <p className="text-xs text-gray-500 mt-1">Adicione seu primeiro produto acima</p>
             </div>
          ) : (
            products.map((p) => (
              <div
